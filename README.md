...
Enabled yearly seasonality.

Forecasting: Created a 24-month ahead forecast with 95% Confidence Intervals for y values, namely yhat

3. Visualization (Power BI)

Data Modeling: Imported Rossmann_Store_Forecast, a Python

Dashboard Features:

Trend Analysis: Comparison of line graphs of Historical Actuals and Future Forecasts.
